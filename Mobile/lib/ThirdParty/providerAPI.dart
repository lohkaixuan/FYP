// ==================================================
// Program Name   : providerAPI.dart
// Purpose        : Third-party provider API integration
  ...
  Future<void> _saveKeys() async {
    ...
    try {
      ...
      if (e is DioException && e.response?.statusCode == 400) {
        final msg =
            e.response?.data?.toString() ?? 'Backend requires all fields?';
        ApiDialogs.showError(
          msg,
              ...
              decoration: InputDecoration(
                  ...
                  suffixIcon: Row(mainAxisSize: MainAxisSize.min, children: [
                    IconButton(
                      ...
                      onPressed: () =>
                          setState(() => _isPublicVisible = !_isPublicVisible),
                    ),
                    IconButton(
